...
void setup()
{
  ...
  createWorld(0);
  createPlayer();
  playerImage=loadImage("Spirit Knight mega.png");
  backgroundImage=loadImage("war 5.png");
  
  enemyImage=loadImage("lightning pawn.png");
  ballImage=loadImage("spiritball1.png");
  nemesisImage=loadImage("lightning knight.png");
