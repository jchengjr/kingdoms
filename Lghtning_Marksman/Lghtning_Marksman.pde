...
void setup()
{
  ...
  createWorld(0);
  createPlayer();
  playerImage=loadImage("Lightning Knight mega.png");
  backgroundImage=loadImage("war 4.png");
  
  enemyImage=loadImage("spirit pawn.png");
  ballImage=loadImage("lightning arrow.png");
  nemesisImage=loadImage("spirit knight.png");
