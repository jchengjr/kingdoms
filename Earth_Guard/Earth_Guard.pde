...
void setup()
{
  ...
  createWorld(0);
  createPlayer();
  playerImage=loadImage("Earth Knight mega.png");
  backgroundImage=loadImage("war3.png");
  
  enemyImage=loadImage("air pawn.png");
  ballImage=loadImage("earthball1.png");
  nemesisImage=loadImage("air knight.png");
