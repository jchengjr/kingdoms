...
void setup()
{
  ...
  createWorld(0);
  createPlayer();
  playerImage=loadImage("Ice Knight mega.png");
  backgroundImage=loadImage("war2.png");
  
  enemyImage=loadImage("fire pawn.png");
  ballImage=loadImage("iceball1.png");
  nemesisImage=loadImage("fire knight.png");
